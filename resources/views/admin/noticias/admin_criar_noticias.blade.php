...
@section('title', 'Admin - Criar Notícia')
...
<h1 style="font-family: Eczar">Criar Notícia</h1>
    <div class="col-md-6 offset-md-3">
        <form action="/admin/noticias" method="POST" enctype="multipart/form-data" name="Form" onsubmit="return validateForm()">
        @csrf
