...
@section('title', 'Admin - Criar Galeria Notícia')
...
<h1 style="font-family: Eczar">Adicionar Galeria Notícia: {{$noticia->titulo}}</h1>
    <div class="col-md-6 offset-md-3">
        <form action="/admin/galeria_noticias/{{$noticia->id}}" method="POST" enctype="multipart/form-data">
        @csrf
